...
private:
    ...
    void recreateSwapChain() {
        ...
        std::cout << "Window resized to: " << swapChainExtent.width << "x" << swapChainExtent.height
                  << " (aspect ratio: " << (swapChainExtent.width / (float)swapChainExtent.height) << ")" << std::endl;
    }
